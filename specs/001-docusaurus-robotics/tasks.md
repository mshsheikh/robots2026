...
1 | scaffold docusaurus + package.json | 2 | unassigned | [X]
2 | create book/docs/intro.md (180w) | 1 | unassigned | 1 [X]
3 | create week1 stub (3 bullets) | 0.5 | unassigned | 1 [X]
...
7 | create requirements.txt | 0.25 | unassigned | 1
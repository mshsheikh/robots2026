...
prompt_text: |
  ...
  output:
    ...
    - suggested commit message: "feat(rag): add /query and /query_selected endpoints with CORS and Neon placeholders"
    - PHR title: "RAG FastAPI main.py — Endpoints & Qdrant Integration"
response_text: |
...
evaluation: |
  The changes meet all requirements in the spec: new endpoints added, CORS configured, Qdrant integration included, Neon placeholder added, and existing functionality preserved.
---

# RAG FastAPI main.py — Endpoints & Qdrant Integration

## Summary
Updated the RAG FastAPI main.py file to add new query endpoints, Qdrant integration, CORS configuration, and Neon database placeholder.

## Changes Made
- Added /query endpoint for basic document retrieval
- Added /query_selected endpoint for context-aware retrieval
- Configured CORS middleware for frontend integration
- Implemented Qdrant client with connection handling
- Added Neon Postgres placeholder with connection logic
- Preserved all existing functionality and endpoints
